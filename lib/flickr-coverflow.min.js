(function(){var l,m,a;typeof console!=="undefined"&&console!==null&&console.log('*** WARNING *** Enhancing String object with "capitalize()" method');String.prototype.capitalize=function(){return this.length>1?""+this[0].toUpperCase()+this.slice(1,this.length+1||9E9).toLowerCase():(this.length=1,this.toUpperCase())};typeof Logger!=="undefined"&&Logger!==null&&(a=new Logger({level:LogLevel.INFO}));m=function(){function b(c,f,b){this.size=c;this.containerSelector=f;this.renderIn3D=b!=null?b:!1;if(!e[this.size])throw Error(""+
this.size+" is not a valid flickr-coverflow size");if(!this.containerSelector||!$(this.containerSelector))throw Error(""+this.containerSelector+" is not a valid css selector");a!=null&&a.info("Render in 3D: "+this.renderIn3D);Number.prototype.percentOf=function(a){var c;if(!a)throw Error("width cannot be null or empty");c=a.replace(/\d*/,"");a=parseInt(a);return""+Math.round(this/100*a)+c};d=[0,0,(15).percentOf(this.width()),(35).percentOf(this.width()),(55).percentOf(this.width()),(70).percentOf(this.width()),
(70).percentOf(this.width())];delete Number.prototype.percentOf;a!=null&&a.debug("positions: "+d)}var h,e,d,c,f,i;e={tiny:{url:"url_t",height:"102px",width:"250px",imgMaxWidth:"71px",urlZoom:"url_s"},small:{url:"url_s",height:"202px",width:"480px",imgMaxWidth:"143px",urlZoom:"url_m"},medium:{url:"url_m",height:"302px",width:"960px",imgMaxWidth:"215px",urlZoom:"url_m"}};c=["-webkit-","-moz-","-o-","-ms-",""];f=function(a){var f;return function(){var b,i,d;d=[];for(b=0,i=c.length;b<i;b++)f=c[b],d.push(""+
f+"transform: "+a+";");return d}().join("\n")};d=[];h=function(){var a;return/(opera|presto)/gi.test((a=window.navigator)!=null?a.userAgent:void 0)};i=function(a,c,b){return h()?"margin-left: "+a+";":f("translateX("+a+") translateZ("+b+")")};b.prototype.imageContainer="flickrCoverflow-image-container";b.prototype.style3d=function(){return"<style>\n\t."+this.imageContainer+"[data-position='0'] .flickrCoverflow-image {\n\t\t"+f("perspective(700px) scale(.2) translateZ(0) rotateY(0)")+"\n\t}\n\n\t."+
this.imageContainer+"[data-position='1'] .flickrCoverflow-image {\n\t\t"+f("perspective(700px) scale(.65) translateZ(0) rotateY(45deg)")+"\n\t}\n\n\t."+this.imageContainer+"[data-position='2'] .flickrCoverflow-image {\n\t\t"+f("perspective(500px) scale(.65) translateZ(100px) rotateY(45deg)")+"\n\t}\n\n\t."+this.imageContainer+"[data-position='3'] .flickrCoverflow-image {\n\t\t"+f("perspective(0) scale(1) translateZ(200px) rotateY(0)")+"\n\t}\n\n\t."+this.imageContainer+"[data-position='4'] .flickrCoverflow-image {\n\t\t"+
...
this.imageContainer+"[data-position='2'] .flickrCoverflow-image,\n\t."+this.imageContainer+"[data-position='4'] .flickrCoverflow-image {\n\t\tbox-shadow: 0 0 10px #000;\n\t}\n\n\t."+this.imageContainer+"[data-position='3'] .flickrCoverflow-image {\n\t\tbox-shadow: 0 0 20px #000;\n\t}\n\n\n\n\t."+this.imageContainer+"[data-position='0'] {\n\t\tz-index: 0;\n\t\topacity: 0;\n\t\t"+i(this.position(0),0,0)+"\n\t}\n\n\t."+this.imageContainer+"[data-position='1'] {\n\t\tz-index: 1;\n\t\t"+i(this.position(1),
0,0)+"\n\t}\n\n\t."+this.imageContainer+"[data-position='2'] {\n\t\tz-index: 2;\n\t\t"+i(this.position(2),0,"100px")+"\n\t}\n\n\t."+this.imageContainer+"[data-position='3'] {\n\t\tz-index: 4;\n\t\t"+i(this.position(3),0,"200px")+"\n\t}\n\n\t."+this.imageContainer+"[data-position='4'] {\n\t\tz-index: 2;\n\t\t"+i(this.position(4),0,"100px")+"\n\t}\n\n\t."+this.imageContainer+"[data-position='5'] {\n\t\tz-index: 1;\n\t\t"+i(this.position(5),0,0)+"\n\t}\n\n\t."+this.imageContainer+"[data-position='6'] {\n\t\tz-index: 0;\n\t\topacity: 0;\n\t\t"+
i(this.position(6),0,0)+"\n\t}\n\n\t.flickrCoverflow-img {\n\t\tvertical-align: inherit;\n\t\tmax-height: 100%;\n\t}\n</style>"};b.prototype.position=function(c){if((c!=null?c.constructor:void 0)!==Number)throw Error("position must be a not null Number");a!=null&&a.debug("positions: "+d);a!=null&&a.debug("calculating position("+c+") = "+d[c]);return d[c]};b.prototype.width=function(){return e[this.size].width};b.prototype.height=function(){return e[this.size].height};b.prototype.url=function(){return e[this.size].url};
b.prototype.urlZoom=function(){return e[this.size].urlZoom};b.prototype.maxWidth=function(){return e[this.size].imgMaxWidth};b.prototype.apply=function(){var c;a!=null&&a.debug("about to apply required style");c=$("head");this.renderIn3D&&c.prepend(this.style3d());c.prepend("<style>\n\t.flickrCoverflow-img {\n\t\tmax-width: "+this.maxWidth()+";\n\t}\n</style>");return c.prepend(this.style())};return b}();l=function(){function b(c,f,b,e){var g,h;this.apiKey=c;this.user=f;this.htmlNode=b;this.options=
e!=null?e:{size:"tiny"};if(a!=null)a.info("Coverflow html node: <"+(typeof(h=this.htmlNode).prop==="function"?h.prop("tagName"):void 0)+":"+this.htmlNode.selector+"/>");if(this.pageSize%2===0)throw Error("page size must be odd, actual = "+this.pageSize);this.htmlNode.attr({"data-version":d});this.style=new m(this.options.size,this.htmlNode.selector,this.options.renderIn3D);this.images="."+this.style.imageContainer+"[data-template=no]";this.createImageTemplate();this.style.apply();this.offset=this.startX=
0;this.photos=[];this.page=1;this.median=(this.pageSize-1)/2;this.medianImage="."+this.style.imageContainer+"[data-position='"+this.median+"']";this.source+="&api_key="+this.apiKey+"&user_id="+this.user+"&per_page="+this.pageSize*2;this.attachEvents();if(typeof logLevelIsTrace==="function"&&logLevelIsTrace())for(g in this)c=this[g],a!=null&&a.trace(""+g+": "+c);if(typeof logLevelIsTrace==="function"&&logLevelIsTrace())for(g in f=this.htmlNode,f)c=f[g],a!=null&&a.trace("@htmlNode properties: \n"+g+
": "+c)}var h,e,d;h=!1;d="0.5.2";e=function(){return $.os.ios||$.os.android||$.os.webos||$.os.touchpad||$.os.iphone||$.os.ipad||$.os.blackberry&&/7\.[1-9]\d*/g.test($.os.version)};b.prototype.previousButton=".flickrCoverflow-previous";b.prototype.nextButton=".flickrCoverflow-next";b.prototype.pageSize=7;b.prototype.source="http://www.flickr.com/services/rest/?method=flickr.people.getPublicPhotos&format=json&nojsoncallback=1&extras=url_t,url_s,url_m";b.prototype.version=function(){return d};b.prototype.createImageTemplate=
...
b.prototype.load=function(){var c,b=this;c=""+this.source+"&page="+this.page;a!=null&&a.info("load > Page source: "+c);return $.getJSON(c,function(c){var d,g,e,k;if(!b.photos.length||!c.photos.photo.length&&!h){h=!c.photos.photo.length;d={placeHolder:!0,title:"none",url_t:"data:image/png;base64,",
...
for(g=0;g<=2;++g)b.photos.push(d)}k=c.photos.photo;for(g=0,e=k.length;g<e;g++)d=k[g],b.photos.push(d);a!=null&&a.debug(""+b.photos.length+" loaded");a!=null&&a.debug(""+c.photos.total+" photos to handle");c=b.photos.slice(b.offset,b.pageSize);for(g=0,e=c.length;g<e;g++)d=c[g],b.appendPhoto(d);b.setImagesPosition();return b.addZoomEvent()})};b.prototype.appendPhoto=function(c,b){var d;b==null&&(b=null);a!=null&&a.debug("append photo");d=this.createImageFrom(c);$("img",d).error(function(){a!=null&&
...
return b};b.prototype.attachEvents=function(){a!=null&&a.debug("median = "+this.median);a!=null&&a.debug("offset in attachEvents: "+this.offset);return e()?this.attachTouchEvents():(this.attachNextEvent(),this.attachPreviousEvent())};b.prototype.attachNextEvent=function(){var a=this;return $(this.nextButton,this.htmlNode).bind("mousedown",function(){return a.next()}).css("cursor","pointer")};b.prototype.attachPreviousEvent=function(){var a=this;return $(this.previousButton,this.htmlNode).bind("mousedown",
function(){return a.previous()}).css("cursor","pointer")};b.prototype.addZoomEvent=function(){var b,f,d=this;f=e()?"tap":"click";a!=null&&a.debug("median image selector: '"+this.medianImage+"'");b=$(this.medianImage,this.htmlNode).css({cursor:"pointer"});return b.bind(f,function(){a!=null&&a.debug("about to trigger 'zoom' event");return d.htmlNode.trigger($.Event("zoom",{zoomUrl:b.attr("data-zoom-url")}))})};b.prototype.hasNext=function(){return this.photos[this.offset+this.pageSize]};b.prototype.next=
...
b.prototype.showNextPhoto=function(){a!=null&&a.debug("show photo");return $(this.images).eq(this.offset+this.pageSize).attr({"data-show":"yes"})};b.prototype.loadNewPageIfPageChanged=function(){if(!this.isSamePage()&&(this.page++,a!=null&&a.debug("page "+this.page),!this.nextPhotoIsLoaded()))return this.load()};b.prototype.isSamePage=function(){return this.offset%this.pageSize!==0};b.prototype.appendNextPhotoIfAny=function(){var b;if(b=this.hasNext())return a!=null&&a.debug("photo '"+b.title+"' exists at index "+
(this.offset+this.pageSize)),this.offset++,this.appendPhoto(b),this.loadNewPageIfPageChanged()};b.prototype.setImagesPosition=function(){var b,d,e,h,g,j;g=$("."+this.style.imageContainer+"[data-show='yes']");j=[];for(d=e=0,h=g.length;e<h;d=++e)b=g[d],a!=null&&a.debug("position + median: "+d+", image: "+b),j.push($(b).attr({"data-position":d}));return j};b.prototype.previous=function(){a!=null&&a.debug("previous image");a!=null&&a.debug("offset before previous: "+this.offset);this.offset&&(this.clearZoomEvent(),
...
return a!=null?a.debug("@startX: "+b.startX):void 0});this.htmlNode.bind("touchmove",function(){return b.touchMoveHandler()});return this.htmlNode.bind("touchend",function(){return b.deltaX=0})};return b}();(function(b){return b.fn.flickrCoverflow=function(b,e,d){d==null&&(d={size:"tiny"});a!=null&&a.info("Using flickrCoverflow jQuery plugin");this.css("display")!=="none"?(b=new l(b,e,this,d),b.load(),a!=null&&a.info("flickrCoverflow selector: "+b.htmlNode.selector)):a!=null&&a.info(""+this.attr("id")+
