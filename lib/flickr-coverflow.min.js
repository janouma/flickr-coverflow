...
this.startX=c,this.deltaX=0,this.previous(),a!=null&&a.debug("@deltaX after previous(): "+this.deltaX);if(this.deltaX<-70)return a!=null&&a.debug("@deltaX before next(): "+this.deltaX),this.startX=c,this.deltaX=0,this.next(),a!=null?a.debug("@deltaX after next(): "+this.deltaX):void 0};b.prototype.attachTouchEvents=function(){var c=this;a!=null&&a.debug("attaching touch events");a!=null&&a.debug("@htmlNode.id: "+this.htmlNode.attr("id"));this.htmlNode.bind("touchstart",function(b){c.startX=b.targetTouches[0].pageX;
return a!=null?a.debug("@startX: "+c.startX):void 0});this.htmlNode.bind("touchmove",function(){return c.touchMoveHandler()});return this.htmlNode.bind("touchend",function(){return c.deltaX=0})};return b}();(function(b){return b.fn.flickrCoverflow=function(b,f,g){g==null&&(g={size:"tiny"});a!=null&&a.info("Using flickrCoverflow jQuery plugin");this.css("display")!=="none"?(b=new j(b,f,this,g),b.load(),a!=null&&a.info("flickrCoverflow selector: "+b.htmlNode.selector)):a!=null&&a.info(""+this.attr("id")+
