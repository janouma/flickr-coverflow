let CoverflowStyle = {
	...
	insertSheets(){
		...
		if(!document.getElementById(d2Id)){
			...
			Logger.debug("[FlickrCoverflow] - insertSheet -", d2Id, ":", minifiedStyle);

			head.insertAdjacentElement("afterbegin", d2Style);
		}

		if(this._3d && !document.getElementById(d3Id)){
			// Resetting RegExp
			...
			Logger.debug("[FlickrCoverflow] - insertSheet -", d3Id, ":", minifiedStyle);
