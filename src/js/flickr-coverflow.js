...
class FlickrCoverflow {
  ...
  _createImageTemplate () {
    ...
    template.innerHTML = `<div class="flickrCoverflow-inner-frame">
				<img class="flickrCoverflow-image" src="${FlickrCoverflow._placeholder}" />
