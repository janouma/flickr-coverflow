...
class Coverflow {
  ...
  static set logLevel (level) {
    Logger.level = level;
    Logger.info('%cFlickr Coverflow 2.1.0', 'font-size:80%;padding:0.2em 0.5em;color:#FFFFD5;background-color:#FF0066;');
  }
...
export { Coverflow, FlickrDataSource, Logger, Signal, Validator };
//# sourceMappingURL=flickr-coverflow-2.1.0-dev.js.map
